...
class DeveloperAgent:
    ...
    def _build_prompt(
        ...
        return (
            ...
            "\n"
            "CRITICAL: Every line must be functional, tested mentally, and beautiful.\n"
            ...
            "\n"
            "MANDATORY RULES:\n"
            "1. If you create a class/function, ALWAYS instantiate/call it at the end\n"
            "2. For game files: MUST have init code like 'const game = new Game(); game.start();'\n"
            "3. For HTML: MUST load scripts in correct order (<script src='...'> at end of body)\n"
            "4. NO orphan code - everything must connect and execute\n"
            "\n"
